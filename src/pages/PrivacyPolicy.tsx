                    ...
                    <section>
                        ...
                        <div className="mt-4 flex flex-wrap items-center gap-4 text-sm">
                            <div className="flex items-center gap-2 text-slate-400">
                                <strong>Email:</strong> <span>contact@toolkit-lab.com</span>
                            </div>
                            <span className="text-slate-700">|</span>
                            <Link to="/contact" className="inline-flex items-center gap-2 text-indigo-400 hover:text-indigo-300 font-semibold transition-colors">
                                <Send className="w-4 h-4" />
                                {t('privacy.contact.form_link')}
                            </Link>
                        </div>
                    </section>
                </div>
